...
sap.ui.define([
	...
	opaTest("MasterList Filtering on valor less than 100", function(Given, When, Then) {

		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
			and.iSelectListItemInViewSettingsDialog("<valor>").
			and.iSelectListItemInViewSettingsDialog("<100 <q_compra>").
	...
	opaTest("MasterList Filtering on valor more than 100", function(Given, When, Then) {
		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
			and.iSelectListItemInViewSettingsDialog(">100 <q_compra>").
			and.iPressOKInViewSelectionDialog();
