sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("Coxinha_Hana/Coxinha.v02/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("Coxinha_Hana.Coxinha.v02.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["Coxinha_Hana/Coxinha.v02/localService/mockserver"], function (mockserver) {
