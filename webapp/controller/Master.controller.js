/*global history */
sap.ui.define([
		"Coxinha_Hana/Coxinha.v02/controller/BaseController",
		"sap/ui/model/json/JSONModel",
		"sap/ui/model/Filter",
		"sap/ui/model/FilterOperator",
		"sap/m/GroupHeaderListItem",
		"sap/ui/Device",
		"Coxinha_Hana/Coxinha.v02/model/formatter",
		"Coxinha_Hana/Coxinha.v02/model/grouper",
		...
		return BaseController.extend("Coxinha_Hana.Coxinha.v02.controller.Master", {
			...
			onSearch : function (oEvent) {
				...
				if (sQuery) {
					this._oListFilterState.aSearch = [new Filter("id_pro", FilterOperator.Contains, sQuery)];
				} else {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("Coxinha_Hana.Coxinha.v02.view.ViewSettingsDialog", this);
			...
			_onMasterMatched :  function() {
				this.getOwnerComponent().oListSelector.oWhenListLoadingIsDone.then(
					function (mParams) {
						...
						var sObjectId = mParams.firstListitem.getBindingContext().getProperty("id_ped");
			...
			_showDetail : function (oItem) {
				...
				this.getRouter().navTo("object", {
					objectId : oItem.getBindingContext().getProperty("id_ped")
				}, bReplace);
			},
